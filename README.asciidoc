...
|lib/check-manifest.pl         |Perl script that compares the manifest section
                                of `README.asciidoc` with the distribution
                                file `source.tds.zip`.
...
|tex/ltugboat.cfg          |setup for class ltugboat
...
2014/11/13::
  * Program +lib/check-manifest.pl+ added, manifest section
    of +README+ fixed, and missing source files added to module source.
